...
old = '  // Round of 16 (real stats)\n  "Canada_Morocco": ['
new = '  // Round of 16 (real stats)\n  "Canada_Morocco": ['

# Find and replace the entire R16 stats block
import re

r16_block_old = '''  // Round of 16 (real stats)
  "Canada_Morocco": [
    {type:"Ball Possession",home:"45%",away:"55%"},
    {type:"Total Shots",home:10,away:5},
  ...
  "Brazil_Norway": [
    {type:"Ball Possession",home:"34%",away:"66%"},
  ...
  "Mexico_England": [
    ...
    {type:"Total Shots",home:13,away:18},
    {type:"Shots on Target",home:5,away:7},
    {type:"Corners",home:5,away:8},
  ...
  "Portugal_Spain": [
    ...
    {type:"Total Shots",home:12,away:17},
    {type:"Shots on Target",home:4,away:6},
    {type:"Corners",home:4,away:8},
  ...
  "USA_Belgium": [
    ...
    {type:"Total Shots",home:9,away:22},
    {type:"Shots on Target",home:3,away:9},
    {type:"Corners",home:3,away:11},
  ...
  "Argentina_Egypt": [
    ...
    {type:"Total Shots",home:20,away:11},
    {type:"Shots on Target",home:7,away:4},
    {type:"Corners",home:8,away:4},
  ...
  "Switzerland_Colombia": [
    ...
    {type:"Total Shots",home:13,away:14},
...
r16_block_new = '''  // Round of 16 (real stats)
  "Canada_Morocco": [
    {type:"Ball Possession",home:"45%",away:"55%"},
...
if r16_block_old in content:
    content = content.replace(r16_block_old, r16_block_new, 1)
