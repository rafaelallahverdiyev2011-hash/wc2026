...
r16_lineups = '''
  ...
  "Paraguay_France": {
    ...
    homeStartXI: [
      ...
      {id:11,name:"Gabriel Ávalos",number:21,position:"CF"},
    ],
    homeSubs: [
      {id:12,name:"Julio Enciso",number:19,position:"FW"},
    ...
    awaySubs: [
      ...
      {id:33,name:"Jean-Philippe Mateta",number:22,position:"FW"},
    ],
  },
  "Brazil_Norway": {
  ...
  "Switzerland_Colombia": {
    ...
    homeSubs: [
      ...
      {id:14,name:"Michel Aebischer",number:20,position:"MF"},
    ],
    awayStartXI: [
...
if old in content:
    ...
    old2 = "export const HARDCODED_LINEUPS: Record<string, MatchLineup> = {"
    new2 = "export const HARDCODED_LINEUPS: Record<string, MatchLineup> = {" + r16_lineups
    if old2 in content:
