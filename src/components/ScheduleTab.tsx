...
const GROUP_FIXTURES: StaticMatch[] = [
  ...
  { matchNum:19, group:'D', home:'USA', homeFlag:'🇺🇸', away:'Paraguay', awayFlag:'🇵🇾', date:'2026-06-12', timeET:'9:00 PM ET',  stadium:'SoFi Stadium',            city:'Los Angeles',        stage:'Group Stage' },
