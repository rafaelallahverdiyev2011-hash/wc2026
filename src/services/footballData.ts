...
export const HARDCODED_LINEUPS: Record<string, MatchLineup> = {
  ...
  // Quarterfinals
  "Morocco_France": {
    homeTeam:"Morocco",awayTeam:"France",
    ...
    homeStartXI:[
      ...
      {id:3,name:"Anass Salah-Eddine",number:5,position:"CB"},
      {id:4,name:"Issa Diop",number:14,position:"CB"},
      {id:5,name:"Noussair Mazraoui",number:3,position:"LB"},
      {id:6,name:"Neil El Aynaoui",number:24,position:"CM"},
      {id:7,name:"Ayyoub Bouaddi",number:6,position:"CM"},
      ...
      {id:11,name:"Chemsdine Talbi",number:7,position:"CF"},
    ],
    homeSubs:[
      {id:12,name:"Soufiane Rahimi",number:9,position:"FW"},
      {id:13,name:"Ismael Saibari",number:11,position:"FW"},
    ],
    awayStartXI:[
      {id:20,name:"Mike Maignan",number:16,position:"GK"},
      {id:21,name:"Jules Kounde",number:5,position:"RB"},
      ...
      {id:25,name:"Manu Kone",number:8,position:"CM"},
      {id:26,name:"Adrien Rabiot",number:14,position:"CM"},
      {id:27,name:"Ousmane Dembele",number:7,position:"RW"},
      {id:28,name:"Michael Olise",number:11,position:"AM"},
      {id:29,name:"Desire Doue",number:20,position:"LW"},
      {id:30,name:"Kylian Mbappe",number:10,position:"CF"},
    ],
    awaySubs:[
      {id:31,name:"Bradley Barcola",number:12,position:"FW"},
  ...
  "Spain_Belgium": {
    ...
    homeStartXI:[
      ...
      {id:6,name:"Fabian Ruiz",number:8,position:"CM"},
      {id:7,name:"Rodri",number:16,position:"CM"},
      {id:8,name:"Lamine Yamal",number:19,position:"RW"},
      {id:9,name:"Dani Olmo",number:10,position:"AM"},
      {id:10,name:"Alex Baena",number:15,position:"LW"},
      {id:11,name:"Mikel Oyarzabal",number:21,position:"CF"},
    ],
    homeSubs:[
      {id:12,name:"Pedri",number:20,position:"MF"},
      {id:13,name:"Nico Williams",number:7,position:"FW"},
    ],
    awayStartXI:[
      ...
      {id:23,name:"Nathan Ngoy",number:3,position:"CB"},
      {id:24,name:"Maxim De Cuyper",number:5,position:"LB"},
      {id:25,name:"Nicolas Raskin",number:6,position:"CM"},
      {id:26,name:"Youri Tielemans",number:8,position:"CM"},
      {id:27,name:"Charles De Ketelaere",number:17,position:"RW"},
      {id:28,name:"Kevin De Bruyne",number:7,position:"AM"},
      {id:29,name:"Jeremy Doku",number:11,position:"LW"},
      {id:30,name:"Leandro Trossard",number:10,position:"CF"},
    ],
    awaySubs:[
      {id:31,name:"Romelu Lukaku",number:9,position:"FW"},
      {id:32,name:"Dodi Lukebakio",number:14,position:"FW"},
    ],
  },
  "Norway_England": {
    homeTeam:"Norway",awayTeam:"England",
    homeFormation:"4-3-3",awayFormation:"4-2-3-1",
    homeStartXI:[
      {id:1,name:"Orjan Nyland",number:1,position:"GK"},
      {id:2,name:"Julian Ryerson",number:16,position:"RB"},
      ...
      {id:6,name:"Patrick Berg",number:6,position:"CM"},
      {id:7,name:"Sander Berge",number:8,position:"CM"},
      {id:8,name:"Martin Odegaard",number:10,position:"CM"},
      {id:9,name:"Andrea Schjelderup",number:21,position:"RF"},
      {id:10,name:"Erling Haaland",number:9,position:"CF"},
      {id:11,name:"Alexander Sorloth",number:7,position:"LF"},
    ],
    homeSubs:[
      {id:12,name:"Antonio Nusa",number:20,position:"FW"},
      {id:13,name:"Oscar Bobb",number:22,position:"MF"},
    ],
    awayStartXI:[
      {id:20,name:"Jordan Pickford",number:1,position:"GK"},
      {id:21,name:"Ezri Konsa",number:2,position:"RB"},
      {id:22,name:"Marc Guehi",number:6,position:"CB"},
      {id:23,name:"John Stones",number:5,position:"CB"},
      {id:24,name:"Nico OReilly",number:3,position:"LB"},
      {id:25,name:"Elliot Anderson",number:8,position:"CM"},
      {id:26,name:"Declan Rice",number:4,position:"CM"},
      {id:27,name:"Jude Bellingham",number:10,position:"AM"},
      {id:28,name:"Noni Madueke",number:20,position:"RW"},
      {id:29,name:"Harry Kane",number:9,position:"CF"},
      {id:30,name:"Anthony Gordon",number:18,position:"LW"},
    ],
    awaySubs:[
      {id:31,name:"Bukayo Saka",number:7,position:"FW"},
      {id:32,name:"Marcus Rashford",number:11,position:"FW"},
    ],
  },
  "Argentina_Switzerland": {
    ...
    homeStartXI:[
      ...
      {id:5,name:"Nicolas Tagliafico",number:3,position:"LB"},
      {id:6,name:"Rodrigo De Paul",number:7,position:"RM"},
      {id:7,name:"Enzo Fernandez",number:24,position:"CM"},
      {id:8,name:"Alexis Mac Allister",number:20,position:"CM"},
      {id:9,name:"Leandro Paredes",number:5,position:"LM"},
      {id:10,name:"Lionel Messi",number:10,position:"CF"},
      {id:11,name:"Julian Alvarez",number:9,position:"CF"},
    ],
    homeSubs:[
      {id:12,name:"Lautaro Martinez",number:22,position:"FW"},
      {id:13,name:"Thiago Almada",number:16,position:"MF"},
    ],
    awayStartXI:[
      ...
      {id:25,name:"Granit Xhaka",number:10,position:"CM"},
      {id:26,name:"Remo Freuler",number:8,position:"CM"},
      {id:27,name:"Dan Ndoye",number:11,position:"RW"},
      {id:28,name:"Djibril Sow",number:22,position:"AM"},
      {id:29,name:"Fabian Rieder",number:9,position:"LW"},
      {id:30,name:"Breel Embolo",number:7,position:"CF"},
    ],
    awaySubs:[
      {id:31,name:"Noah Okafor",number:19,position:"FW"},
      {id:32,name:"Zeki Amdouni",number:23,position:"FW"},
    ],
  },
  // Semifinals
  "France_Spain": {
    ...
    homeSubs:[
      ...
      {id:13,name:"Manu Kone",number:6,position:"MF"},
    ],
    awayStartXI:[
      {id:20,name:"Unai Simon",number:23,position:"GK"},
      {id:21,name:"Pedro Porro",number:12,position:"RB"},
      {id:22,name:"Pau Cubarsi",number:22,position:"CB"},
      {id:23,name:"Aymeric Laporte",number:14,position:"CB"},
      {id:24,name:"Marc Cucurella",number:24,position:"LB"},
      {id:25,name:"Fabian Ruiz",number:8,position:"CM"},
      {id:26,name:"Rodri",number:16,position:"CM"},
      {id:27,name:"Lamine Yamal",number:19,position:"RW"},
      {id:28,name:"Dani Olmo",number:10,position:"AM"},
      {id:29,name:"Alex Baena",number:15,position:"LW"},
      {id:30,name:"Mikel Oyarzabal",number:21,position:"CF"},
    ],
    awaySubs:[
      {id:31,name:"Pedri",number:20,position:"MF"},
      {id:32,name:"Nico Williams",number:7,position:"FW"},
    ],
  },
  "England_Argentina": {
    ...
    homeStartXI:[
      ...
      {id:3,name:"Marc Guehi",number:6,position:"CB"},
      {id:4,name:"John Stones",number:5,position:"CB"},
      {id:5,name:"Reece James",number:22,position:"LB"},
      {id:6,name:"Declan Rice",number:4,position:"CM"},
      {id:7,name:"Jude Bellingham",number:10,position:"AM"},
      {id:8,name:"Elliot Anderson",number:8,position:"CM"},
      {id:9,name:"Anthony Gordon",number:18,position:"LW"},
      {id:10,name:"Harry Kane",number:9,position:"CF"},
      {id:11,name:"Morgan Rogers",number:14,position:"RW"},
    ],
    homeSubs:[
      {id:12,name:"Bukayo Saka",number:7,position:"FW"},
      {id:13,name:"Ollie Watkins",number:11,position:"FW"},
    ],
    awayStartXI:[
      ...
      {id:25,name:"Giuliano Simeone",number:11,position:"RM"},
      {id:26,name:"Enzo Fernandez",number:24,position:"CM"},
      {id:27,name:"Leandro Paredes",number:5,position:"CM"},
      {id:28,name:"Alexis Mac Allister",number:20,position:"LM"},
      {id:29,name:"Lionel Messi",number:10,position:"CF"},
      {id:30,name:"Julian Alvarez",number:9,position:"CF"},
    ],
    awaySubs:[
      {id:31,name:"Lautaro Martinez",number:22,position:"FW"},
      {id:32,name:"Rodrigo De Paul",number:7,position:"MF"},
    ],
  },
  // Third Place
  "France_England": {
    ...
    homeFormation:"4-2-3-1",awayFormation:"4-2-3-1",
    homeStartXI:[
      {id:1,name:"Brice Samba",number:23,position:"GK"},
      {id:2,name:"Malo Gusto",number:15,position:"RB"},
      {id:3,name:"Ibrahima Konate",number:4,position:"CB"},
      {id:4,name:"Maxence Lacroix",number:17,position:"CB"},
      {id:5,name:"Theo Hernandez",number:22,position:"LB"},
      {id:6,name:"Manu Kone",number:6,position:"CM"},
      {id:7,name:"Warren Zaire-Emery",number:26,position:"CM"},
      {id:8,name:"Maghnes Akliouche",number:25,position:"RW"},
      {id:9,name:"Rayan Cherki",number:24,position:"AM"},
      {id:10,name:"Desire Doue",number:20,position:"LW"},
      {id:11,name:"Jean-Philippe Mateta",number:22,position:"CF"},
    ],
    homeSubs:[
      {id:12,name:"Marcus Thuram",number:9,position:"FW"},
      {id:13,name:"Bradley Barcola",number:12,position:"FW"},
    ],
    awayStartXI:[
      {id:20,name:"Dean Henderson",number:13,position:"GK"},
      {id:21,name:"Tino Livramento",number:23,position:"RB"},
      {id:22,name:"Ezri Konsa",number:2,position:"CB"},
      {id:23,name:"Daniel Burn",number:16,position:"CB"},
      {id:24,name:"Nico OReilly",number:3,position:"LB"},
      {id:25,name:"Kobbie Mainoo",number:26,position:"CM"},
      {id:26,name:"Jordan Henderson",number:6,position:"CM"},
      {id:27,name:"Eberechi Eze",number:21,position:"AM"},
      {id:28,name:"Bukayo Saka",number:7,position:"RW"},
      {id:29,name:"Ivan Toney",number:17,position:"CF"},
      {id:30,name:"Marcus Rashford",number:11,position:"LW"},
    ],
    awaySubs:[
      {id:31,name:"Ollie Watkins",number:15,position:"FW"},
      {id:32,name:"Morgan Rogers",number:14,position:"FW"},
    ],
  },
  // Final
  "Spain_Argentina": {
    ...
    homeSubs:[
      {id:12,name:"Pedri",number:20,position:"MF"},
      {id:13,name:"Nico Williams",number:7,position:"FW"},
      {id:14,name:"Mikel Merino",number:6,position:"MF"},
    ],
    awayStartXI:[
      {id:20,name:"Emiliano Martinez",number:23,position:"GK"},
      {id:21,name:"Nahuel Molina",number:26,position:"RB"},
      ...
      {id:23,name:"Lisandro Martinez",number:6,position:"CB"},
      {id:24,name:"Nicolas Tagliafico",number:3,position:"LB"},
      {id:25,name:"Rodrigo De Paul",number:7,position:"RM"},
      {id:26,name:"Leandro Paredes",number:5,position:"CM"},
      {id:27,name:"Enzo Fernandez",number:24,position:"CM"},
      {id:28,name:"Alexis Mac Allister",number:20,position:"LM"},
      {id:29,name:"Lionel Messi",number:10,position:"CF"},
      {id:30,name:"Julian Alvarez",number:9,position:"CF"},
    ],
    awaySubs:[
      {id:31,name:"Lautaro Martinez",number:22,position:"FW"},
      {id:32,name:"Giuliano Simeone",number:11,position:"MF"},
    ],
  },
  // Group Stage Matchday 3
  "Czech Republic_Mexico": {
    homeTeam:"Czech Republic",awayTeam:"Mexico",
    homeFormation:"4-2-3-1",awayFormation:"4-1-4-1",
    homeStartXI:[
      ...
      {id:9,name:"Jan Kuchta",number:12,position:"AM"},
      {id:10,name:"Ondrej Lingr",number:10,position:"LW"},
      {id:11,name:"Patrik Schick",number:9,position:"CF"},
    ],
    homeSubs:[{id:12,name:"Adam Hlozek",number:11,position:"FW"}],
    awayStartXI:[
      {id:20,name:"Raul Rangel",number:1,position:"GK"},
      {id:21,name:"Jorge Sanchez",number:2,position:"RB"},
      {id:22,name:"Cesar Montes",number:3,position:"CB"},
      {id:23,name:"Johan Vasquez",number:5,position:"CB"},
      {id:24,name:"Jesus Gallardo",number:23,position:"LB"},
      {id:25,name:"Edson Alvarez",number:4,position:"DM"},
      {id:26,name:"Roberto Alvarado",number:25,position:"RM"},
      {id:27,name:"Luis Romo",number:7,position:"CM"},
      {id:28,name:"Alexis Vega",number:10,position:"CM"},
      {id:29,name:"Julian Quinones",number:16,position:"LM"},
      {id:30,name:"Santiago Gimenez",number:11,position:"CF"},
    ],
    awaySubs:[{id:31,name:"Raul Jimenez",number:9,position:"FW"}],
  },
  "South Africa_South Korea": {
    homeTeam:"South Africa",awayTeam:"South Korea",
    homeFormation:"5-3-2",awayFormation:"4-3-3",
    homeStartXI:[
      {id:1,name:"Ronwen Williams",number:1,position:"GK"},
      {id:2,name:"Nkosinathi Sibisi",number:19,position:"CB"},
      {id:3,name:"Ime Okon",number:21,position:"CB"},
      {id:4,name:"Mbekezeli Mbokazi",number:14,position:"CB"},
      {id:5,name:"Khuliso Mudau",number:20,position:"RB"},
      {id:6,name:"Oswin Appollis",number:7,position:"LB"},
      {id:7,name:"Teboho Mokoena",number:4,position:"CM"},
      {id:8,name:"Thalente Mbatha",number:5,position:"CM"},
      {id:9,name:"Jayden Adams",number:23,position:"CM"},
      {id:10,name:"Evidence Makgopa",number:17,position:"CF"},
      {id:11,name:"Iqraam Rayners",number:15,position:"CF"},
    ],
    homeSubs:[{id:12,name:"Themba Zwane",number:11,position:"MF"}],
    awayStartXI:[
      ...
      {id:30,name:"Cho Gue-sung",number:12,position:"LF"},
    ],
    awaySubs:[{id:31,name:"Na Sang-ho",number:11,position:"FW"}],
  },
  "Bosnia & Herzegovina_Qatar": {
    homeTeam:"Bosnia & Herzegovina",awayTeam:"Qatar",
    homeFormation:"4-3-3",awayFormation:"4-3-3",
    homeStartXI:[
      {id:1,name:"Nikola Vasilj",number:1,position:"GK"},
      {id:2,name:"Amar Dedic",number:7,position:"RB"},
      {id:3,name:"Nikola Katic",number:18,position:"CB"},
      {id:4,name:"Tarik Muharemovic",number:4,position:"CB"},
      {id:5,name:"Sead Kolasinac",number:5,position:"LB"},
      {id:6,name:"Benjamin Tahirovic",number:6,position:"CM"},
      {id:7,name:"Ivan Sunjic",number:14,position:"CM"},
      {id:8,name:"Armin Gigovic",number:8,position:"CM"},
      {id:9,name:"Esmir Bajraktarevic",number:20,position:"RW"},
      {id:10,name:"Edin Dzeko",number:11,position:"CF"},
      {id:11,name:"Ermedin Demirovicc",number:10,position:"LW"},
    ],
    homeSubs:[{id:12,name:"Haris Tabakoviccc",number:23,position:"FW"}],
    awayStartXI:[
      ...
      {id:29,name:"Yusuf Abdurisag",number:12,position:"CF"},
  ...
  "Switzerland_Canada": {
    ...
    homeStartXI:[
      ...
      {id:10,name:"Noah Okafor",number:19,position:"LW"},
      {id:11,name:"Breel Embolo",number:7,position:"CF"},
    ],
    homeSubs:[{id:12,name:"Ruben Vargas",number:17,position:"FW"}],
    awayStartXI:[
      {id:20,name:"Maxime Crepeau",number:16,position:"GK"},
      {id:21,name:"Alistair Johnston",number:2,position:"RB"},
      {id:22,name:"Moise Bombito",number:15,position:"CB"},
      {id:23,name:"Luc de Fougerolles",number:4,position:"CB"},
      {id:24,name:"Richie Laryea",number:22,position:"LB"},
      {id:25,name:"Tajon Buchanan",number:17,position:"RM"},
      {id:26,name:"Stephen Eustaquio",number:7,position:"CM"},
      {id:27,name:"Ali Ahmed",number:26,position:"CM"},
      {id:28,name:"Jacob Shaffelburg",number:14,position:"LM"},
      {id:29,name:"Jonathan David",number:10,position:"CF"},
      {id:30,name:"Tani Oluwaseyi",number:12,position:"CF"},
    ],
    awaySubs:[{id:31,name:"Alphonso Davies",number:19,position:"DF"}],
  },
  "Scotland_Morocco": {
    ...
    homeStartXI:[
      ...
      {id:8,name:"Kenny McLean",number:13,position:"CM"},
      {id:9,name:"Ryan Christie",number:9,position:"RW"},
      {id:10,name:"Che Adams",number:10,position:"CF"},
      {id:11,name:"Lyndon Dykes",number:12,position:"LW"},
    ],
    homeSubs:[{id:12,name:"Ryan Gauld",number:11,position:"MF"}],
    awayStartXI:[
      ...
      {id:28,name:"Chemsdine Talbi",number:7,position:"AM"},
      {id:29,name:"Bilal El Khannouss",number:23,position:"LW"},
      {id:30,name:"Soufiane Rahimi",number:9,position:"CF"},
    ],
    awaySubs:[{id:31,name:"Ismael Saibari",number:11,position:"FW"}],
  },
  "Brazil_Haiti": {
    ...
    homeSubs:[{id:12,name:"Matheus Cunha",number:9,position:"FW"}],
    awayStartXI:[
      ...
      {id:28,name:"Derrick Etienne",number:12,position:"LM"},
      {id:29,name:"Carnejy Antoine",number:10,position:"CF"},
      {id:30,name:"Kevin Lafrance",number:11,position:"CF"},
    ],
    awaySubs:[],
  },
  "Turkey_Paraguay": {
    homeTeam:"Turkey",awayTeam:"Paraguay",
    homeFormation:"4-3-3",awayFormation:"4-4-2",
    homeStartXI:[
      ...
      {id:7,name:"Okay Yokuslu",number:13,position:"CM"},
      {id:8,name:"Arda Guler",number:10,position:"CM"},
      {id:9,name:"Kerem Akturkoglu",number:7,position:"RW"},
      {id:10,name:"Cenk Tosun",number:9,position:"CF"},
      {id:11,name:"Baris Alper Yilmaz",number:11,position:"LW"},
    ],
    homeSubs:[{id:12,name:"Salih Ozcan",number:6,position:"MF"}],
    awayStartXI:[
  ...
  "USA_Australia": {
    homeTeam:"USA",awayTeam:"Australia",
    ...
    homeSubs:[{id:12,name:"Ricardo Pepi",number:9,position:"FW"}],
    awayStartXI:[
      {id:20,name:"Patrick Beach",number:18,position:"GK"},
      {id:21,name:"Alessandro Circati",number:3,position:"CB"},
      {id:22,name:"Harry Souttar",number:19,position:"CB"},
      {id:23,name:"Lucas Herrington",number:25,position:"CB"},
      {id:24,name:"Jordan Bos",number:5,position:"RM"},
      {id:25,name:"Jackson Irvine",number:22,position:"CM"},
      {id:26,name:"Aiden ONeill",number:13,position:"CM"},
      {id:27,name:"Aziz Behich",number:16,position:"LM"},
      {id:28,name:"Nestory Irankunda",number:17,position:"RF"},
      {id:29,name:"Mohamed Toure",number:9,position:"CF"},
      {id:30,name:"Cristian Volpato",number:20,position:"LF"},
    ],
    awaySubs:[{id:31,name:"Connor Metcalfe",number:8,position:"MF"}],
  },
  "Tunisia_Netherlands": {
    homeTeam:"Tunisia",awayTeam:"Netherlands",
    homeFormation:"4-3-3",awayFormation:"3-4-3",
    homeStartXI:[
      {id:1,name:"Aymen Dahmen",number:1,position:"GK"},
      {id:2,name:"Mohamed Drager",number:2,position:"RB"},
      {id:3,name:"Montassar Talbi",number:3,position:"CB"},
      {id:4,name:"Yassine Meriah",number:4,position:"CB"},
      {id:5,name:"Ali Abdi",number:5,position:"LB"},
      {id:6,name:"Ellyes Skhiri",number:6,position:"CM"},
      {id:7,name:"Aissa Laidouni",number:7,position:"CM"},
      {id:8,name:"Wahbi Khazri",number:8,position:"CM"},
      {id:9,name:"Hannibal Mejbri",number:9,position:"RW"},
      {id:10,name:"Issam Jebali",number:10,position:"CF"},
      {id:11,name:"Seifeddine Jaziri",number:11,position:"LW"},
    ],
    homeSubs:[{id:12,name:"Naim Sliti",number:12,position:"MF"}],
    awayStartXI:[
      {id:20,name:"Bart Verbruggen",number:1,position:"GK"},
      {id:21,name:"Jan Paul van Hecke",number:6,position:"CB"},
      {id:22,name:"Virgil van Dijk",number:4,position:"CB"},
      {id:23,name:"Nathan Ake",number:5,position:"CB"},
      {id:24,name:"Denzel Dumfries",number:22,position:"RM"},
      {id:25,name:"Ryan Gravenberch",number:8,position:"CM"},
      {id:26,name:"Teun Koopmeiners",number:20,position:"CM"},
      {id:27,name:"Micky van de Ven",number:15,position:"LM"},
      {id:28,name:"Crysencio Summerville",number:24,position:"RF"},
      {id:29,name:"Wout Weghorst",number:9,position:"CF"},
      {id:30,name:"Cody Gakpo",number:11,position:"LF"},
    ],
    awaySubs:[{id:31,name:"Brian Brobbey",number:19,position:"FW"}],
  },
  "Ecuador_Germany": {
    ...
    homeStartXI:[
      ...
      {id:10,name:"Kevin Rodriguez",number:11,position:"CF"},
      {id:11,name:"Enner Valencia",number:13,position:"CF"},
    ],
    homeSubs:[{id:12,name:"Gonzalo Plata",number:19,position:"FW"}],
    awayStartXI:[
      {id:20,name:"Manuel Neuer",number:1,position:"GK"},
      {id:21,name:"Joshua Kimmich",number:6,position:"RB"},
      {id:22,name:"Jonathan Tah",number:4,position:"CB"},
      {id:23,name:"Antonio Rudiger",number:2,position:"CB"},
      {id:24,name:"Nathaniel Brown",number:18,position:"LB"},
      {id:25,name:"Felix Nmecha",number:23,position:"CM"},
      {id:26,name:"Aleksandar Pavlovic",number:5,position:"CM"},
      {id:27,name:"Leroy Sane",number:19,position:"RW"},
      {id:28,name:"Florian Wirtz",number:17,position:"AM"},
      {id:29,name:"Jamal Musiala",number:10,position:"LW"},
      {id:30,name:"Deniz Undav",number:26,position:"CF"},
    ],
    awaySubs:[{id:31,name:"Nick Woltemade",number:11,position:"FW"}],
  },
  "Curacao_Ivory Coast": {
    homeTeam:"Curacao",awayTeam:"Ivory Coast",
    homeFormation:"4-3-3",awayFormation:"4-3-3",
    homeStartXI:[
      {id:1,name:"Eloy Room",number:1,position:"GK"},
      {id:2,name:"Cuco Martina",number:2,position:"RB"},
      {id:3,name:"Ethan Flemming",number:3,position:"CB"},
      {id:4,name:"Rangelo Janga",number:4,position:"CB"},
      {id:5,name:"Jurien Gaari",number:5,position:"LB"},
      {id:6,name:"Jarchinio Antonia",number:6,position:"CM"},
      {id:7,name:"Leandro Bacuna",number:7,position:"CM"},
      {id:8,name:"Gevaro Nepomuceno",number:8,position:"CM"},
      {id:9,name:"Quentin Bautista",number:9,position:"RW"},
      {id:10,name:"Gino van Kessel",number:10,position:"CF"},
      {id:11,name:"Jafar Arias",number:11,position:"LW"},
    ],
    homeSubs:[],
    awayStartXI:[
      ...
      {id:28,name:"Elye Wahi",number:12,position:"CF"},
      {id:29,name:"Ange-Yoan Bonny",number:9,position:"CF"},
      {id:30,name:"Christ Inao Oulai",number:26,position:"LW"},
    ],
    awaySubs:[{id:31,name:"Nicolas Pepe",number:19,position:"FW"}],
  },
  "Japan_Tunisia": {
    homeTeam:"Japan",awayTeam:"Tunisia",
    ...
    homeStartXI:[
      ...
      {id:7,name:"Kaishu Sano",number:24,position:"CM"},
    ...
    homeSubs:[{id:12,name:"Daichi Kamada",number:15,position:"MF"}],
    awayStartXI:[
      ...
      {id:26,name:"Hannibal Mejbri",number:9,position:"CM"},
      {id:27,name:"Naim Sliti",number:12,position:"CM"},
      {id:28,name:"Wahbi Khazri",number:8,position:"RW"},
  ...
  "Uruguay_Spain": {
    ...
    homeFormation:"4-3-3",awayFormation:"4-3-3",
    homeStartXI:[
      {id:1,name:"Sergio Rochet",number:1,position:"GK"},
      {id:2,name:"Nahitan Nandez",number:2,position:"RB"},
      {id:3,name:"Jose Maria Gimenez",number:3,position:"CB"},
      {id:4,name:"Ronald Araujo",number:4,position:"CB"},
      {id:5,name:"Mathias Olivera",number:5,position:"LB"},
      {id:6,name:"Lucas Torreira",number:6,position:"DM"},
      {id:7,name:"Rodrigo Bentancur",number:7,position:"CM"},
      {id:8,name:"Giorgian de Arrascaeta",number:13,position:"CM"},
      {id:9,name:"Facundo Pellistri",number:9,position:"RW"},
      {id:10,name:"Darwin Nunez",number:10,position:"CF"},
      {id:11,name:"Maximiliano Araujo",number:11,position:"LW"},
    ],
    homeSubs:[{id:12,name:"Federico Valverde",number:8,position:"MF"}],
    awayStartXI:[
      {id:20,name:"Unai Simon",number:23,position:"GK"},
      {id:21,name:"Pedro Porro",number:12,position:"RB"},
      {id:22,name:"Pau Cubarsi",number:22,position:"CB"},
      ...
      {id:26,name:"Mikel Merino",number:6,position:"CM"},
      {id:27,name:"Pedri",number:20,position:"CM"},
      {id:28,name:"Lamine Yamal",number:19,position:"RF"},
      {id:29,name:"Mikel Oyarzabal",number:21,position:"CF"},
      {id:30,name:"Alex Baena",number:15,position:"LF"},
    ],
    awaySubs:[{id:31,name:"Ferran Torres",number:7,position:"FW"}],
  },
  "Saudi Arabia_Cape Verde": {
    homeTeam:"Saudi Arabia",awayTeam:"Cape Verde",
    ...
    homeStartXI:[
      ...
      {id:7,name:"Sami Al-Naji",number:8,position:"CM"},
      {id:8,name:"Abdulrahman Al-Aboud",number:7,position:"CM"},
      {id:9,name:"Salem Al-Dawsari",number:9,position:"RW"},
      {id:10,name:"Ali Al-Hassan",number:12,position:"CF"},
    ...
    awayStartXI:[
      ...
      {id:27,name:"Jamiro Monteiro",number:10,position:"CM"},
      {id:28,name:"Deroy Duarte",number:14,position:"CM"},
      {id:29,name:"Jovane Cabral",number:7,position:"LM"},
      {id:30,name:"Dailon Livramento",number:19,position:"CF"},
    ],
    awaySubs:[],
  },
  "New Zealand_Belgium": {
    ...
    homeFormation:"4-4-2",awayFormation:"4-2-3-1",
    homeStartXI:[
      {id:1,name:"Oliver Sail",number:1,position:"GK"},
      {id:2,name:"Liberato Cacace",number:2,position:"RB"},
      {id:3,name:"Niko Kirwan",number:3,position:"CB"},
      {id:4,name:"Winston Reid",number:4,position:"CB"},
      {id:5,name:"Michael Boxall",number:5,position:"LB"},
      {id:6,name:"Marko Stamenic",number:6,position:"RM"},
      {id:7,name:"Liam McGing",number:7,position:"CM"},
      {id:8,name:"Clayton Lewis",number:8,position:"CM"},
      {id:9,name:"Elijah Just",number:9,position:"LM"},
      {id:10,name:"Chris Wood",number:10,position:"CF"},
      {id:11,name:"Kosta Barbarouses",number:12,position:"CF"},
    ],
    homeSubs:[{id:12,name:"Ben Old",number:11,position:"FW"}],
    awayStartXI:[
      {id:20,name:"Thibaut Courtois",number:1,position:"GK"},
      {id:21,name:"Timothy Castagne",number:21,position:"RB"},
      {id:22,name:"Brandon Mechele",number:4,position:"CB"},
      ...
      {id:28,name:"Kevin De Bruyne",number:7,position:"AM"},
      {id:29,name:"Dodi Lukebakio",number:14,position:"LW"},
      {id:30,name:"Romelu Lukaku",number:9,position:"CF"},
    ],
    awaySubs:[{id:31,name:"Jeremy Doku",number:11,position:"FW"}],
  },
  "Egypt_Iran": {
    ...
    homeStartXI:[
      ...
      {id:8,name:"Mohamed Salah",number:10,position:"RW"},
      {id:9,name:"Marwan Attia",number:19,position:"AM"},
      {id:10,name:"Omar Marmoush",number:22,position:"LW"},
      {id:11,name:"Haissem Hassan",number:12,position:"CF"},
    ],
    homeSubs:[{id:12,name:"Mostafa Ziko",number:11,position:"FW"}],
    awayStartXI:[
      ...
      {id:26,name:"Ahmad Noorollahi",number:12,position:"CM"},
  ...
  "Senegal_Iraq": {
    ...
    homeFormation:"4-3-3",awayFormation:"4-4-2",
    homeStartXI:[
      {id:1,name:"Mory Diaw",number:23,position:"GK"},
      {id:2,name:"Krepin Diatta",number:15,position:"RB"},
      {id:3,name:"Pathe Ciss",number:6,position:"CB"},
      {id:4,name:"Moussa Niakhate",number:19,position:"CB"},
      {id:5,name:"Ismail Jakobs",number:14,position:"LB"},
      {id:6,name:"Idrissa Gueye",number:5,position:"CM"},
      {id:7,name:"Lamine Camara",number:8,position:"CM"},
      {id:8,name:"Habib Diarra",number:21,position:"CM"},
      {id:9,name:"Iliman Ndiaye",number:13,position:"RF"},
      {id:10,name:"Nicolas Jackson",number:11,position:"CF"},
      {id:11,name:"Sadio Mane",number:10,position:"LF"},
    ],
    homeSubs:[{id:12,name:"Ismaila Sarr",number:18,position:"FW"}],
    awayStartXI:[
  ...
  "Norway_France": {
    ...
    homeStartXI:[
      ...
      {id:8,name:"Oscar Bobb",number:22,position:"RW"},
      {id:9,name:"Martin Odegaard",number:10,position:"AM"},
      {id:10,name:"Antonio Nusa",number:20,position:"LW"},
      {id:11,name:"Erling Haaland",number:9,position:"CF"},
    ],
    homeSubs:[{id:12,name:"Alexander Sorloth",number:7,position:"FW"}],
    awayStartXI:[
      {id:20,name:"Mike Maignan",number:16,position:"GK"},
      {id:21,name:"Jules Kounde",number:5,position:"RB"},
      {id:22,name:"Dayot Upamecano",number:4,position:"CB"},
      {id:23,name:"William Saliba",number:17,position:"CB"},
      {id:24,name:"Lucas Digne",number:3,position:"LB"},
      {id:25,name:"Aurelien Tchouameni",number:8,position:"CM"},
      {id:26,name:"Adrien Rabiot",number:14,position:"CM"},
      {id:27,name:"Ousmane Dembele",number:7,position:"RW"},
      {id:28,name:"Rayan Cherki",number:24,position:"AM"},
      {id:29,name:"Bradley Barcola",number:12,position:"LW"},
      {id:30,name:"Kylian Mbappe",number:10,position:"CF"},
    ],
    awaySubs:[{id:31,name:"Michael Olise",number:11,position:"MF"}],
  },
  "Algeria_Austria": {
    homeTeam:"Algeria",awayTeam:"Austria",
    homeFormation:"4-3-3",awayFormation:"4-2-3-1",
    homeStartXI:[
      {id:1,name:"Luca Zidane",number:23,position:"GK"},
      {id:2,name:"Rafik Belghali",number:17,position:"RB"},
      {id:3,name:"Aissa Mandi",number:2,position:"CB"},
      {id:4,name:"Ramy Bensebaini",number:21,position:"CB"},
      {id:5,name:"Rayan Ait-Nouri",number:15,position:"LB"},
      {id:6,name:"Ramiz Zerrouki",number:6,position:"CM"},
      {id:7,name:"Fares Chaibi",number:10,position:"CM"},
      {id:8,name:"Nabil Bentaleb",number:19,position:"DM"},
      {id:9,name:"Riyad Mahrez",number:7,position:"RF"},
      {id:10,name:"Ibrahim Maza",number:22,position:"CF"},
      {id:11,name:"Amine Gouiri",number:9,position:"LF"},
    ],
    homeSubs:[{id:12,name:"Anis Hadj Moussa",number:11,position:"FW"}],
    awayStartXI:[
      ...
      {id:28,name:"Marcel Sabitzer",number:9,position:"AM"},
      {id:29,name:"Paul Wanner",number:24,position:"LW"},
      {id:30,name:"Michael Gregoritsch",number:11,position:"CF"},
    ],
    awaySubs:[{id:31,name:"Marko Arnautovic",number:7,position:"FW"}],
  },
  "Jordan_Algeria": {
    ...
    awayStartXI:[
      ...
      {id:26,name:"Houssem Aouar",number:8,position:"CM"},
      {id:27,name:"Anis Hadj Moussa",number:11,position:"CM"},
      {id:28,name:"Riyad Mahrez",number:7,position:"RF"},
      {id:29,name:"Amine Gouiri",number:9,position:"CF"},
      {id:30,name:"Ibrahim Maza",number:22,position:"LF"},
    ],
    awaySubs:[],
  },
  "Argentina_Austria": {
    ...
    homeStartXI:[
      ...
      {id:9,name:"Nico Gonzalez",number:15,position:"LM"},
      {id:10,name:"Lionel Messi",number:10,position:"CF"},
      {id:11,name:"Lautaro Martinez",number:22,position:"CF"},
    ],
    homeSubs:[{id:12,name:"Julian Alvarez",number:9,position:"FW"}],
    awayStartXI:[
      {id:20,name:"Alexander Schlager",number:1,position:"GK"},
      {id:21,name:"Stefan Posch",number:5,position:"RB"},
      {id:22,name:"Kevin Danso",number:3,position:"CB"},
      ...
      {id:24,name:"Konrad Laimer",number:20,position:"LB"},
      {id:25,name:"Nicolas Seiwald",number:6,position:"CM"},
      {id:26,name:"Florian Grillitsch",number:10,position:"CM"},
      {id:27,name:"Romano Schmid",number:18,position:"RW"},
      {id:28,name:"Marcel Sabitzer",number:9,position:"AM"},
      {id:29,name:"Paul Wanner",number:24,position:"LW"},
      {id:30,name:"Marko Arnautovic",number:7,position:"CF"},
    ],
    awaySubs:[{id:31,name:"Michael Gregoritsch",number:11,position:"FW"}],
  },
  "D.R. Congo_Portugal": {
    homeTeam:"D.R. Congo",awayTeam:"Portugal",
    homeFormation:"4-4-2",awayFormation:"4-3-3",
    homeStartXI:[
      ...
      {id:9,name:"Meschak Elia",number:13,position:"LM"},
      {id:10,name:"Yoane Wissa",number:20,position:"CF"},
      {id:11,name:"Brian Cipenga",number:9,position:"CF"},
    ],
    ...
    awayStartXI:[
      ...
      {id:27,name:"Vitinha",number:23,position:"CM"},
      {id:28,name:"Pedro Neto",number:18,position:"RW"},
      {id:29,name:"Goncalo Ramos",number:9,position:"CF"},
      {id:30,name:"Rafael Leao",number:17,position:"LW"},
    ],
    awaySubs:[{id:31,name:"Cristiano Ronaldo",number:7,position:"FW"}],
  },
  "Uzbekistan_Colombia": {
    ...
    awayStartXI:[
      ...
      {id:26,name:"Richard Rios",number:6,position:"CM"},
      {id:27,name:"Gustavo Puerta",number:14,position:"CM"},
      {id:28,name:"James Rodriguez",number:10,position:"RF"},
      {id:29,name:"Luis Diaz",number:7,position:"LF"},
      {id:30,name:"Jhon Cordoba",number:9,position:"CF"},
    ],
    awaySubs:[{id:31,name:"Luis Suarez",number:25,position:"FW"}],
  },
  "Panama_England": {
    ...
    homeStartXI:[
      ...
      {id:11,name:"Gabriel Torres",number:12,position:"CF"},
    ],
    homeSubs:[],
    awayStartXI:[
      {id:20,name:"Jordan Pickford",number:1,position:"GK"},
      ...
      {id:22,name:"Ezri Konsa",number:2,position:"CB"},
      {id:23,name:"Marc Guehi",number:6,position:"CB"},
      {id:24,name:"Nico OReilly",number:3,position:"LB"},
      {id:25,name:"Declan Rice",number:4,position:"CM"},
      {id:26,name:"Elliot Anderson",number:8,position:"CM"},
    ...
    awaySubs:[{id:31,name:"Marcus Rashford",number:11,position:"FW"}],
  },
  "Croatia_Ghana": {
    homeTeam:"Croatia",awayTeam:"Ghana",
    homeFormation:"4-3-3",awayFormation:"4-5-1",
    homeStartXI:[
      {id:1,name:"Dominik Livakovic",number:1,position:"GK"},
      {id:2,name:"Josip Stanisic",number:2,position:"RB"},
      {id:3,name:"Josip Sutalo",number:6,position:"CB"},
      {id:4,name:"Marin Pongracic",number:3,position:"CB"},
      {id:5,name:"Ivan Perisic",number:14,position:"LB"},
      {id:6,name:"Luka Modric",number:10,position:"CM"},
      {id:7,name:"Mateo Kovacic",number:8,position:"CM"},
      {id:8,name:"Mario Pasalic",number:15,position:"CM"},
      {id:9,name:"Nikola Vlasic",number:13,position:"RW"},
      {id:10,name:"Ante Budimir",number:11,position:"CF"},
      {id:11,name:"Martin Baturina",number:16,position:"LW"},
    ],
    homeSubs:[{id:12,name:"Igor Matanovic",number:20,position:"FW"}],
    awayStartXI:[
      ...
      {id:27,name:"Abdul Fatawu",number:7,position:"CM"},
  ...
  "Portugal_Uzbekistan": {
    ...
    homeSubs:[{id:12,name:"Goncalo Ramos",number:9,position:"FW"}],
    awayStartXI:[
  ...
  "Colombia_Uzbekistan": {
    homeTeam:"Colombia",awayTeam:"Uzbekistan",
    homeFormation:"4-3-3",awayFormation:"4-4-2",
    homeStartXI:[
      ...
      {id:8,name:"Gustavo Puerta",number:14,position:"CM"},
      {id:9,name:"James Rodriguez",number:10,position:"RF"},
      {id:10,name:"Luis Diaz",number:7,position:"LF"},
      {id:11,name:"Luis Suarez",number:25,position:"CF"},
    ],
    homeSubs:[{id:12,name:"Jhon Cordoba",number:9,position:"FW"}],
    awayStartXI:[
      {id:20,name:"Abduvohid Nishonov",number:1,position:"GK"},
      {id:21,name:"Sherzod Nasrullayev",number:2,position:"RB"},
      {id:22,name:"Abbosbek Fayzullayev",number:3,position:"CB"},
  ...
  "England_Croatia_3": {
    ...
    homeSubs:[{id:12,name:"Anthony Gordon",number:18,position:"FW"}],
    awayStartXI:[
      ...
      {id:27,name:"Petar Sucic",number:17,position:"CM"},
      {id:28,name:"Nikola Vlasic",number:13,position:"RW"},
      {id:29,name:"Ante Budimir",number:11,position:"CF"},
      {id:30,name:"Igor Matanovic",number:20,position:"LW"},
    ],
    awaySubs:[{id:31,name:"Mario Pasalic",number:15,position:"MF"}],
  },
  "Ghana_Panama_3": {
    ...
    homeStartXI:[
      ...
      {id:8,name:"Abdul Fatawu",number:7,position:"CM"},
    ...
    homeSubs:[{id:12,name:"Ernest Nuamah",number:24,position:"FW"}],
    awayStartXI:[
      ...
      {id:25,name:"Adalberto Carrasquilla",number:6,position:"RM"},
      {id:26,name:"Jose Fajardo",number:7,position:"CM"},
      {id:27,name:"Roderick Miller",number:8,position:"CM"},
      {id:28,name:"Cecilio Waterman",number:9,position:"LM"},
      {id:29,name:"Gabriel Torres",number:12,position:"CF"},
      {id:30,name:"Ismael Diaz",number:10,position:"CF"},
    ],
    awaySubs:[],
  },
...
export const HARDCODED_STATS: Record<string, MatchStatItem[]> = {
  ...
  "Morocco_France": [
    {type:"Ball Possession",home:"51%",away:"49%"},
    {type:"Total Shots",home:5,away:22},
    {type:"Shots on Target",home:1,away:8},
    {type:"Corners",home:1,away:3},
    {type:"Fouls",home:5,away:6},
    {type:"Yellow Cards",home:0,away:0},
    {type:"Red Cards",home:0,away:0},
  ],
  "Spain_Belgium": [
    {type:"Ball Possession",home:"68%",away:"32%"},
    {type:"Total Shots",home:12,away:3},
    {type:"Shots on Target",home:8,away:2},
    {type:"Corners",home:5,away:1},
    {type:"Fouls",home:13,away:18},
    {type:"Yellow Cards",home:2,away:2},
    {type:"Red Cards",home:0,away:0},
  ],
  "Norway_England": [
    {type:"Ball Possession",home:"48%",away:"52%"},
    {type:"Total Shots",home:10,away:11},
    {type:"Shots on Target",home:4,away:8},
    {type:"Corners",home:7,away:4},
    {type:"Fouls",home:10,away:8},
    {type:"Yellow Cards",home:1,away:0},
    {type:"Red Cards",home:0,away:0},
  ],
  "Argentina_Switzerland": [
  ...
  "France_Spain": [
    {type:"Ball Possession",home:"48%",away:"52%"},
    {type:"Total Shots",home:6,away:7},
    {type:"Shots on Target",home:3,away:5},
    {type:"Corners",home:3,away:3},
    {type:"Fouls",home:13,away:12},
    {type:"Yellow Cards",home:3,away:1},
    {type:"Red Cards",home:0,away:0},
  ],
  "England_Argentina": [
    {type:"Ball Possession",home:"36%",away:"64%"},
    {type:"Total Shots",home:5,away:15},
    {type:"Shots on Target",home:2,away:5},
    {type:"Corners",home:2,away:6},
  ...
  "France_England": [
    {type:"Ball Possession",home:"48%",away:"52%"},
    {type:"Total Shots",home:19,away:19},
    {type:"Shots on Target",home:8,away:12},
    {type:"Corners",home:5,away:6},
    {type:"Fouls",home:11,away:10},
    {type:"Yellow Cards",home:1,away:1},
    {type:"Red Cards",home:0,away:0},
  ],
  // Final
  "Spain_Argentina": [
    {type:"Ball Possession",home:"65%",away:"35%"},
    {type:"Total Shots",home:20,away:3},
    {type:"Shots on Target",home:11,away:0},
    {type:"Corners",home:9,away:4},
    {type:"Fouls",home:21,away:24},
    {type:"Yellow Cards",home:0,away:5},
    {type:"Red Cards",home:0,away:1},
  ],
  // Round of 16
  "Canada_Morocco": [
